...
% NetID: jpk349 
% Due Date: 3/28/2012
% Assignment: Virtual Surround Sound stereo-ed
% 
% VirtSurrounder2
%   function takes 5 channels of surround sound and makes flattens them into 2 channel stereophonic sound
%
% Inputs:
%
...
function Surround2Stereo( cHRTFfilename , rfHRTFfilename, rbHRTFfilename ...
...
% Make a left and a right channel from your 10 virtual surround sound
    ...
    % rightsVEC for stereo mix
    leftMTX = leftMTX';
    rightMTX = rightMTX';
    
    sumLEFTrow = (sum(leftMTX([1,2,3],:)))/3;
    sumRIGHTrow = (sum(rightMTX([1,4,5],:)))/3;
